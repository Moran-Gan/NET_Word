...
/******************************************************************************
                       1:修改产品信息
******************************************************************************/
#define PRODUCT_KEY "rhitg1yzeufjekiv"    //开发平台创建产品后生成的16位字符产品唯一标识
...
//制热设定温度(可下发可上报)
//备注:
#define DPID_TEMP_SET 9
//工作状态(只上报)
//备注:
#define DPID_WORK_STATE 13
//制冷设定温度(可下发可上报)
//备注:
#define DPID_COOLING_SET 101
//制热水温控制(可下发可上报)
//备注:
#define DPID_HEATING_WATER 102
//制冷水温控制(可下发可上报)
//备注:
#define DPID_COOLING_WATER 103
//开关机状态(只上报)
//备注:
#define DPID_STATE_POWER 104
//进水温度(只上报)
//备注:
#define DPID_TEMP_IN 105
//出水温度(只上报)
//备注:
#define DPID_TEMP_OUT 106
//故障标志位(只上报)
//备注:
#define DPID_BIT_FAULT 107
//传感器故障(只上报)
//备注:
#define DPID_FAULT_TEMP 108
//系统故障1(只上报)
//备注:
#define DPID_SYS_FAULT_1 109
//系统故障2(只上报)
//备注:
#define DPID_SYS_FAULT_2 110
//系统故障3(只上报)
//备注:
#define DPID_SYS_FAULT_3 111
//系统故障4(只上报)
//备注:
#define DPID_SYS_FAULT_4 112
//驱动故障1(只上报)
//备注:
#define DPID_DRIVER_FAULT_1 113
//驱动故障2(只上报)
//备注:
#define DPID_DRIVER_FAULT_2 114
//驱动故障3(只上报)
//备注:
#define DPID_DRIVER_FAULT_3 115
//模块机故障(只上报)
//备注:
#define DPID_MODEL_FAULT 116
//机型选择(只上报)
//备注:
#define DPID_MODEL 117
